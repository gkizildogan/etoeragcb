...
def settings_values(tmp_path: Path) -> dict[str, Any]:
    return {
        ...
        "retrieval_gate_config": Path("app/rag/calibration/retrieval_gate.v1.json"),
        "web_top_results": 5,
        "searxng_url": "http://searxng:8080",
        "web_fetcher_url": "http://web-fetcher:8081",
        "web_fetch_timeout": 8,
        "web_fetch_concurrency": 3,
        "web_max_redirects": 3,
        "web_max_bytes": 2_000_000,
        "web_text_max_chars": 3000,
        "web_context_limit": 4,
        "web_allowed_ports": [80, 443],
        "upload_max_mb": 50,
        "tenant_upload_quota_mb": 1024,
        "allowed_mime": ["application/pdf", "text/plain", "application/x-ndjson"],
        "document_storage_root": tmp_path / "documents",
        "ingest_batch_size": 16,
        "ingestion_heartbeat_timeout": 300,
        "retained_index_generations": 2,
